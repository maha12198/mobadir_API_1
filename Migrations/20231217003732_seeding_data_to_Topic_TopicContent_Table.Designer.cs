...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231217003732_seeding_data_to_Topic_TopicContent_Table")]
    partial class seeding_data_to_Topic_TopicContent_Table
    {
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ContentId = 1,
                            CreatedAt = new DateTime(2023, 12, 17, 4, 37, 31, 912, DateTimeKind.Utc).AddTicks(2664),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        new
                        {
                            Id = 2,
                            ContentId = 2,
                            CreatedAt = new DateTime(2023, 12, 17, 4, 37, 31, 912, DateTimeKind.Utc).AddTicks(2690),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        new
                        {
                            Id = 3,
                            ContentId = 3,
                            CreatedAt = new DateTime(2023, 12, 17, 4, 37, 31, 912, DateTimeKind.Utc).AddTicks(2696),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        new
                        {
                            Id = 4,
                            ContentId = 4,
                            CreatedAt = new DateTime(2023, 12, 17, 4, 37, 31, 912, DateTimeKind.Utc).AddTicks(2701),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
