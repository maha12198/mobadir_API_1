...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231223185225_add-id-to-website-contact-info")]
    partial class addidtowebsitecontactinfo
    {
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 23, 22, 52, 24, 173, DateTimeKind.Utc).AddTicks(759),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 23, 22, 52, 24, 173, DateTimeKind.Utc).AddTicks(772),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 12, 23, 22, 52, 24, 173, DateTimeKind.Utc).AddTicks(783),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 12, 23, 22, 52, 24, 173, DateTimeKind.Utc).AddTicks(794),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
