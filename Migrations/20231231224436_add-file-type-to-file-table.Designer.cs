...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231231224436_add-file-type-to-file-table")]
    partial class addfiletypetofiletable
    {
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 44, 34, 935, DateTimeKind.Local).AddTicks(9144),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 44, 34, 935, DateTimeKind.Local).AddTicks(9216),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 44, 34, 935, DateTimeKind.Local).AddTicks(9225),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 44, 34, 935, DateTimeKind.Local).AddTicks(9232),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
