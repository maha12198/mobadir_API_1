...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231219144733_change_typename_ofDate")]
    partial class change_typename_ofDate
    {
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 19, 18, 47, 32, 292, DateTimeKind.Utc).AddTicks(2283),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 19, 18, 47, 32, 292, DateTimeKind.Utc).AddTicks(2294),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 12, 19, 18, 47, 32, 292, DateTimeKind.Utc).AddTicks(2303),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 12, 19, 18, 47, 32, 292, DateTimeKind.Utc).AddTicks(2312),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
