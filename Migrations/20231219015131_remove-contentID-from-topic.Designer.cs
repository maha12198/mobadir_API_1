...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231219015131_remove-contentID-from-topic")]
    partial class removecontentIDfromtopic
    {
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 19, 5, 51, 31, 478, DateTimeKind.Utc).AddTicks(7055),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 19, 5, 51, 31, 478, DateTimeKind.Utc).AddTicks(7061),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 12, 19, 5, 51, 31, 478, DateTimeKind.Utc).AddTicks(7062),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 12, 19, 5, 51, 31, 478, DateTimeKind.Utc).AddTicks(7064),
                            CreatedBy = 4,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
