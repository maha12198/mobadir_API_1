...
namespace mobadir_API_1.Migrations
{
    ...
    [Migration("20231223213526_new-seeding")]
            ...
            modelBuilder.Entity("mobadir_API_1.Models.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 35, 25, 445, DateTimeKind.Local).AddTicks(1516),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 35, 25, 445, DateTimeKind.Local).AddTicks(1588),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 1,
                            Term = 2,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 35, 25, 445, DateTimeKind.Local).AddTicks(1596),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 1,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 12, 23, 23, 35, 25, 445, DateTimeKind.Local).AddTicks(1604),
                            CreatedBy = 1,
                            IsVisible = true,
                            SubjectId = 6,
                            Term = 2,
